    ...
    public Map<String, Object> exportService_data(String tableName, String base64, RollingResult rollingresult, int cartype) {
        ...
        try {
            ...
            try {
                ...
                String cangtablename = "cang_allitems_" + damsConstruction.getTablename();
                String beforetablename = "cang_ceng_" + damsConstruction.getPid() + "_" + (Integer.valueOf(damsConstruction.getEngcode()) - 1);
                int ishavebefore = cangAllitemsMapper.checktable(beforetablename);
                if (1 == ishavebefore) {
                    CangAllitems before = cangAllitemsMapper.selectCangavgev_before(beforetablename, cangtablename);
                    result.put("beforegaocheng", new BigDecimal(before.getPz() / 100).setScale(2, RoundingMode.HALF_UP));
                }
                CangAllitems cangAllitems = cangAllitemsMapper.selectCangavgev(cangtablename);
                result.put("avggaocheng", new BigDecimal(cangAllitems.getPz() / 100).setScale(2, RoundingMode.HALF_UP));
...
//                for (CarTime carTime : carTimelist) {
    ...
    public void exportdata_topdf(String pdfUrl, Map<String, Object> datas, int cartype) {        // 使用Lambda表达式
        ...
        try {
            ...
            //字体设置
            Font f1 = new Font(baseFont, 16);    // 标题(字体12，加粗，绿色)
            Font f8 = new Font(baseFont, 10);     // 表格中文字

            //段落paragraph 、文本块(Chunk)、短语(Phrase)
            Paragraph paragraph = null;
            // String title ="陕西镇安抽水蓄能电站\r\n坝体填筑数字化大坝监控成果表";
            String title = "工程智能控制系统\r数字化监控成果表";
...
//            paragraph = new Paragraph(materialname + "第" + cengname + "层区域" + rangename + "施工报告", f1);
            ...
            // 单元格
            PdfPCell cell = null;
            cell = new PdfPCell(new Paragraph("单位工程名称及编号", f8));
            cell.setHorizontalAlignment(1);
            ...
            cell.setColspan(2);
            table.addCell(cell);
            cell = new PdfPCell(new Paragraph(datas.get("unitname").toString() + "\r" + datas.get("unitcode").toString(), f8));
            cell.setHorizontalAlignment(1);
            cell.setColspan(3);
            cell.setMinimumHeight(32.0f);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            ...
            cell = new PdfPCell(new Paragraph("施工日期", f8));
            cell.setHorizontalAlignment(1);
            cell.setMinimumHeight(32.0f);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            cell = new PdfPCell(new Paragraph("分部工程名称及编号", f8));
            cell.setHorizontalAlignment(1);
            cell.setColspan(2);
            cell.setMinimumHeight(32.0f);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            ...
            cell = new PdfPCell(new Paragraph(datas.get("partname").toString() + "\r" + datas.get("partcode").toString(), f8));
            cell.setHorizontalAlignment(1);
            cell.setColspan(3);
            cell.setRowspan(2);
            cell.setMinimumHeight(32.0f);
            ...
            cell = new PdfPCell(new Paragraph("起止桩号", f8));
            cell.setHorizontalAlignment(1);
            cell.setRowspan(1);
            cell.setMinimumHeight(32.0f);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            ...
            cell = new PdfPCell(new Paragraph("起止高程", f8));
            cell.setHorizontalAlignment(1);
            cell.setMinimumHeight(32.0f);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            cell = new PdfPCell(new Paragraph("单元工程名称、部位及编号", f8));
            cell.setHorizontalAlignment(1);
            cell.setMinimumHeight(32.0f);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setColspan(2);
            table.addCell(cell);
            cell = new PdfPCell(new Paragraph(datas.get("areaname").toString() + "\r" + datas.get("areacode").toString(), f8));
            cell.setHorizontalAlignment(1);
            cell.setMinimumHeight(32.0f);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            table.addCell(cell);
            if (cartype == 1) {
                cell = new PdfPCell(new Paragraph("碾压遍数", f8));
                cell.setHorizontalAlignment(1);
                cell.setMinimumHeight(32.0f);
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            cell = new PdfPCell(new Paragraph("区域面积", f8));
            cell.setHorizontalAlignment(1);
            cell.setMinimumHeight(32.0f);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            if (cartype == 1) {
                ...
                cell = new PdfPCell(new Paragraph("碾压合格率", f8));
                cell.setHorizontalAlignment(1);
                cell.setMinimumHeight(32.0f);
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                ...
                cell = new PdfPCell(new Paragraph("摊铺合格率", f8));
                cell.setHorizontalAlignment(1);
                cell.setMinimumHeight(32.0f);
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            cell = new PdfPCell(new Paragraph("碾压方量", f8));
            cell.setHorizontalAlignment(1);
            cell.setMinimumHeight(32.0f);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            cell = new PdfPCell(new Paragraph(imgtitle, f8));
            cell.setHorizontalAlignment(1);
            cell.setColspan(2);
            ...
            if (cartype == 2) {
                ...
                cell = new PdfPCell(new Paragraph("压实厚度", f8));
                cell.setHorizontalAlignment(1);
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                cell.setRowspan(1);
                ...
                //0 是符合  1是不符合
                String houduQuality = "";
                if (datas.containsKey("houduQuality")) {
                    int code = (int) datas.get("houduQuality");
                    if (code == 0) {
                        houduQuality = "符合";
                    } else {
                        houduQuality = "不符合";
                ...
                cell = new PdfPCell(new Paragraph(houduQuality, f8));
                cell.setHorizontalAlignment(1);
                cell.setMinimumHeight(32.0f);
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            cell = new PdfPCell(new Paragraph("碾压速度（km/h）", f8));
            cell.setHorizontalAlignment(1);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setRowspan(2);
