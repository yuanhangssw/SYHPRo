 ...
 */
@Slf4j
public class makeCangmatrixItemDataforReal implements Callable<Integer> {
    ...
    public makeCangmatrixItemDataforReal() {
    }
    ...
    public Integer call() throws Exception {
        ...
        if (rollingDataList.size() > 2) {
            ...
            try {
                ...
                Map<String, MatrixItem[][]> storeHouses2RollingData = StoreHouseMap.getStoreHouses2RollingDataCang();
