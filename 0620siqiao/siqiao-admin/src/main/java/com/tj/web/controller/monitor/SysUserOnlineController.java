package com.tj.web.controller.monitor;
...
import com.tj.system.domain.SysUserOnline;
import com.tj.system.service.ISysUserOnlineService;
...
public class SysUserOnlineController extends BaseController
{
    ...
    public TableDataInfo list(String ipaddr, String userName)
    {
        ...
        List<SysUserOnline> userOnlineList = new LinkedList<SysUserOnline>();
        for (String key : keys)
        {
